...
const chipStyles = {
  b2b: "border-[color:var(--blue-700)] text-[color:var(--blue-700)] bg-surface-elevated/5",
  ...
  commercial: "border-[color:var(--blue-700)] text-[color:var(--blue-700)] bg-surface-elevated/5",
